    ...
    return(
      <Container>
           ...
           <div className="alinhando-imagem">
               <button onClick={ () => SetEdit(true)} className="edit"> <img className="img1" src="/assets/Images/Group.svg"/></button>
               <button onClick={ () => setPo(true)} className="del"> <img className="img" src="/assets/Images/Group (1).svg"/></button>
           </div>
