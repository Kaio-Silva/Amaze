...
export default function Menu(props){
    return(props.trigger) ?(
            <Container background={props.background}  home={props.home} login={props.login} contact={props.contact} mapa={props.mapa} relatDenunc={props.relatDenunc} removeUser={props.removeUser} historicop={props.histp} cadastro={props.cadastro} criar={props.criar} >
                <div className="abox">
                <div className="cab">
                ...
                <div className="conteudop">
                   ...
                   <Link className="link" to="/Mapa"> <div className="mapa">Mapa</div></Link>
