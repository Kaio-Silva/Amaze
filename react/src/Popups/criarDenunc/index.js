        ...
        <Container>
          ...
          <div className="abox">
             ...
             <div className="cabecalho">
                 <div className="logo"><Logo cor="verde" tamanho="pequeno"/></div>
             ...
             <div className="forms">
                  ...
                  <div className="inputs">
                      <Textarea onChange={ e => setOcorrencia(e.target.value)} className="ajustarInput" placeholder="Descreva a ocorrência" cor="verde"tamanho="100%"/>
                  </div> 
